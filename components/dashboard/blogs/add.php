<div class="container">
    <div class="white-box">
        <h4>Fill the Following Form To Add Blog</h4>
        <br />
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="blogSlug" placeholder="Enter Blog Slug" readonly>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="blogViews">Blog Views</label>
                    <input type="number" class="form-control" id="blogViews" placeholder="Enter Blog Views">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="blogTags" placeholder="Enter Blog Tags">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="blogDescription" placeholder="Enter Blog Description"></textarea>
                </div>
            </div>
            <div class="col-md-12">
                <div class="form-group">
                    <label for="blogContent">Blog Content</label>
                    <textarea class="form-control texteditor-content" id="blogContent" placeholder="Enter Blog Content"></textarea>
                </div>
            </div>
        </div>
        <div class="p-2">
