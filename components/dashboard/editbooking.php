...
?>
    <div class="mt-4">
        <div class="card shadow p-4">
            ...
            <div class="row mb-3">
                <div class="col-md-6"><label class="form-label fw-bold">Event Date</label>
                    <div class="form-control-plaintext"><?= htmlspecialchars($property['event_date']) ?></div>
                </div>
                <div class="col-md-6"><label class="form-label fw-bold">Event Place</label>
                    <div class="form-control-plaintext"><?= htmlspecialchars($property['event_place']) ?></div>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6"><label class="form-label fw-bold">Package Name</label>
                    <div class="form-control-plaintext"><?= htmlspecialchars($property['package_name']) ?></div>
                </div>
                <div class="col-md-6"><label class="form-label fw-bold">Services Included</label>
                    <div class="form-control-plaintext"><?= htmlspecialchars($property['service_name']) ?></div>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6"><label class="form-label fw-bold">Price</label>
                    <div class="form-control-plaintext">£<?= number_format($property['price'], 2) ?></div>
                </div>
