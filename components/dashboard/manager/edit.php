...
?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="fullname" placeholder="Enter Manager Name" value="<?= $propertyEdit['fullname'] ?>">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="discount_permission" name="discount_permission">
                            <option value="0" <?= isset($propertyEdit['discount_permission']) && $propertyEdit['discount_permission'] == 0 ? 'selected' : '' ?>>No</option>
                            <option value="1" <?= isset($propertyEdit['discount_permission']) && $propertyEdit['discount_permission'] == 1 ? 'selected' : '' ?>>Yes</option>
                        </select>
                    </div>
                </div>
                <?php } ?>
    ...
    <script>
        ...
        $("#managerName").on("input", function() {
            let managerName = $(this).val();
        })
        ...
        $("#saveButton").click(function(event) {
            ...
            swal({
                ...
                if (willDelete) {
                    ...
                    formData.append("mode", "editmanager");
