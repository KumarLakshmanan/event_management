...
$sql = "SELECT *,CASE 
       WHEN govt_emp = 0 THEN 'No'
       WHEN govt_emp = 1 THEN 'Yes'
       ELSE 'Unknown'
   END AS status_text  FROM users where type=1 ORDER BY id DESC";
    ...
    <div class="col-md-12 col-lg-12 col-sm-12">
        <div class="white-box">
            <div class="d-md-flex mb-3">
                <h3 class="box-title mb-0">All Service Man List</h3>
            </div>
                ...
                <table class="table no-wrap bDataTable" id="bDataTable">
                    <thead>
                        <tr>
                            ...
                            <th class="border-top-0">Govt Registered</th>
                            <th class="border-top-0">Govt Reg no</th>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td> <?php if($value['status_text']=='Yes'){?><?php echo $value["govt_rollno"] ?? ""; ?> <?php } ?></td>
