            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="serviceName" placeholder="Enter Service Name" value="<?= $propertyEdit['service_name'] ?>">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
        ...
        $("#saveButton").click(function(event) {
            ...
            swal({
                ...
                if (willDelete) {
                    ...
                    formData.append("mode", "editservice");
                    formData.append("service_id", "<?= $propertyEdit['id'] ?>");
