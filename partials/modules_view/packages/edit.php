...
?>
    <div class="container">
        <div class="white-box">
            <h2>Update Bundles</h2>
            <br />
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="packageName">Bundles Name</label>
                        <input type="text" class="form-control" id="packageName" placeholder="Enter Bundles Name" value="<?= $propertyEdit['package_name'] ?>">
                    </div>
                </div>
                <div class="col-md-6">
                <div class="form-group">
