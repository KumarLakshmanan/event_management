...
<head>
    <meta charset="utf-8">
    <title>EVENT MANAGEMENT: Guest</title>
...
<body>
    ...
    <form id="rsvpForm" method="POST" action="<?php echo $adminBaseUrl ?>rsvp_notattend">
        ...
        <input type="hidden" name="mode" value="rsvp_notattend">
    </form>
    ...
    <script>
        $(document).ready(function() {
            ...
            formdata.append('mode', 'rsvp_notattend');
